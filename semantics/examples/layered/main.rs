...
use axiom_semantics::prelude_all::{CarrierCost, InlineCarrier, QueueCarrier};
...
fn main() {
    ...
    let link_inline = axiom_semantics::prelude_all::assemble_link::<Unit, cells::AsIs, InlineCarrier>(
    ...
    let link_queue = axiom_semantics::prelude_all::assemble_link::<Unit, cells::AsIs, QueueCarrier>(
